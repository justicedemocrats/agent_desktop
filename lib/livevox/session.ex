defmodule Livevox.Session do
  ...
  def clientname, do: Application.get_env(:agent_desktop, :lv_clientname)
  def username, do: Application.get_env(:agent_desktop, :lv_username)
  def password, do: Application.get_env(:agent_desktop, :lv_password)
